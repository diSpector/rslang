        ...
        <div class="aboutTeam_content">
          ...
          <div class="aboutTeam__card">
            ...
            <div class="aboutTeam__card_text">
              ...
              <p class="aboutTeam__card_about">Разработка архитектуры приложения, сервисного слоя, мини-игр "Пазл" и "Скажи это". Тестирование и отладка.</p>
              <div class="aboutTeam__card_contact">
                <div class="aboutTeam__card_contact-github">
                  <div class="aboutTeam__card_contact-githubImage"></div>
          ...
          <div class="aboutTeam__card">
            ...
            <div class="aboutTeam__card_text">
              ...
              <p class="aboutTeam__card_position">Студент</p>
              <p class="aboutTeam__card_about">Разработка мини-игры "Спринт", дизайна приложения, реализация страницы о команде, верстка страницы авторизации.</p>
              <div class="aboutTeam__card_contact">
                <div class="aboutTeam__card_contact-github">
                  <div class="aboutTeam__card_contact-githubImage"></div>
          ...
          <div class="aboutTeam__card">
            ...
            <div class="aboutTeam__card_text">
              ...
              <p class="aboutTeam__card_position">Студент</p>
              <p class="aboutTeam__card_about">Разработка словаря и промо-страницы, адаптация мини-игры "Саванна", создание видео об игре.</p>
              <div class="aboutTeam__card_contact">
                <div class="aboutTeam__card_contact-github">
                  <div class="aboutTeam__card_contact-githubImage"></div>
