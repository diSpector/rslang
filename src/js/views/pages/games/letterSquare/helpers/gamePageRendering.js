export default function gamePageRendering() {
  ...
  <section class="allGames__startScreen letterSquare">
    <h1 class="allGames__heading">Буквенный квадрат</h1>
      ...
      <p>3. На поиск всех слов у вас две минуты</p>
      <p>4. При неправильном выборе букв убери все выделенные ячейки, кликни "Сброс" и начни собирать слово сначала</p>
    ...
    <section class="letterSquare letterSquare__statistic letterSquare-hidden">
      <div class="statistic__card">
        ...
        <div class="statistic__numberWordsFound">Найденные слова: </div>
        <div class="statistic__numberWordsNotFound">Ненайденные слова: </div>
